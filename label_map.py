...
if uploaded_file is not None:
    ...
    data_source = template_file_path()
    data_label = "map.xlsx"

st.divider()

# Process spreadsheet (sample template loads by default)
if data_source is not None:
    try:
        ...
        if uploaded_file is None:
            st.caption(
                "Sample loaded: top 10 countries by population. "
                "Upload your own file to replace it."
            )
    ...
    st.info("Sample template map.xlsx not found.")
